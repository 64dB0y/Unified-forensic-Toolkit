...
%hashdeep% -c sha1,md5,sha256 -c sha1,md5,sha256 "%Memory_Dump_dir%\%current_date%.mem" > "%PHYSICAL_MEMORY_HASH%\RamCapture_hash.txt"
...
%hashdeep% -c sha1,md5,sha256 "%Memory_Dump_dir%\physmem.raw" > "%PHYSICAL_MEMORY_HASH%\physmem_hash.txt"
...
%hashdeep% -c sha1,md5,sha256 "%Memory_Dump_dir%\memory_dump.zip" > "%PHYSICAL_MEMORY_HASH%\memory_dump_hash.txt"
...
::Hash 
::--------------------------------------------------------------
%hashdeep% -c sha1,md5,sha256 "%Network_dir%\arp.txt" > "%NETWORK_HASH%\arp_hash.txt"
echo [!timestamp!] ARP HASH >> %_TimeStamp%

%hashdeep% -c sha1,md5,sha256 "%Network_dir%\route.txt" > "%NETWORK_HASH%\route_hash.txt"
echo [!timestamp!] ROUTE HASH >> %_TimeStamp%

%hashdeep% -c sha1,md5,sha256 "%Network_dir%\netstat.txt" > "%NETWORK_HASH%\netstat_hash.txt"
...
%hashdeep% -c sha1,md5,sha256 "%Network_dir%\ipconfig.txt" > "%NETWORK_HASH%\ipconfig_hash.txt"
echo [!timestamp!] IPCONFIG HASH >> %_TimeStamp%

%hashdeep% -c sha1,md5,sha256 "%Network_dir%\urlprotocolview.txt" > "%NETWORK_HASH%\urlprotocolview_hash.txt"
echo [!timestamp!] URLPROTOCOLVIEW HASH >> %_TimeStamp%

%hashdeep% -c sha1,md5,sha256 "%Network_dir%\cports.txt" > "%NETWORK_HASH%\cports_hash.txt"
echo [!timestamp!] CPORTS HASH >> %_TimeStamp%

%hashdeep% -c sha1,md5,sha256 "%Network_dir%\tcplogview.txt" > "%NETWORK_HASH%\tcplogview_hash.txt"
echo [!timestamp!] TCPLOGVIEW HASH >> %_TimeStamp%

%hashdeep% -c sha1,md5,sha256 "%Network_dir%\wifiInfoView.txt" > "%NETWORK_HASH%\wifiInfoView_hash.txt"
echo [!timestamp!] WIFIINFOVIEW HASH >> %_TimeStamp%

%hashdeep% -c sha1,md5,sha256 "%Network_dir%\WirelessNetView.txt" > "%NETWORK_HASH%\WirelessNetView_hash.txt"
...
if exist "%CHROME_COOKIES%" (
  ...
  %hashdeep% -c sha1,md5,sha256 "%CHROME_DESTINATION%\Cookies" > "%PROCESS_HASH%\Chrome_Cookies_hash.txt"
...
for /D %%i in ("%FIREFOX_PROFILE%\*") do (
  if exist "%%i\%FIREFOX_COOKIES%" (
    ...
    %hashdeep% -c sha1,md5,sha256 "%FIREFOX_DESTINATION%\cookies.sqlite" > "%PROCESS_HASH%\FIREFOX_Cookies_hash.txt"
...
if exist "%EDGE_COOKIES%" (
  ...
  %hashdeep% -c sha1,md5,sha256 "%EDGE_DESTINATION%\Cookies" > "%PROCESS_HASH%\EDGE_Cookies_hash.txt"
...
if exist "%IE_COOKIES%" (
  ...
  %hashdeep% -c sha1,md5,sha256 -r "%IE_DESTINATION%" > "%PROCESS_HASH%\IE_Cookies_hash.txt"
...
if exist "%OPERA_COOKIES%" (
  ...
  %hashdeep% -c sha1,md5,sha256 "%OPERA_DESTINATION%\Cookies" > "%PROCESS_HASH%\OPERA_Cookies_hash.txt"
...
%hashdeep% -c sha1,md5,sha256 "%PROCESS_Dir%\psloglist.txt" > "%PROCESS_HASH%\psloglist_hash.txt"
echo [!timestamp!] PSLOGLIST HASH >> %_TimeStamp%
%hashdeep% -c sha1,md5,sha256 "%PROCESS_Dir%\tasklist.txt" > "%PROCESS_HASH%\tasklist_hash.txt"
echo [!timestamp!] TASKLIST HASH >> %_TimeStamp%

%hashdeep% -c sha1,md5,sha256 "%PROCESS_Dir%\pslist.txt" > "%PROCESS_HASH%\pslist_hash.txt"
echo [!timestamp!] PSLIST HASH >> %_TimeStamp%

%hashdeep% -c sha1,md5,sha256 "%PROCESS_Dir%\listdll.txt" > "%PROCESS_HASH%\listdll_hash.txt"
echo [!timestamp!] LISTDLL HASH >> %_TimeStamp%

%hashdeep% -c sha1,md5,sha256 "%PROCESS_Dir%\handle.txt" > "%PROCESS_HASH%\handle_hash.txt"
echo [!timestamp!] HANDLE HASH >> %_TimeStamp%

%hashdeep% -c sha1,md5,sha256 "%PROCESS_Dir%\regdllview.txt" > "%PROCESS_HASH%\regdllview_hash.txt"
echo [!timestamp!] REGDLLVIEW HASH >> %_TimeStamp%

%hashdeep% -c sha1,md5,sha256 "%PROCESS_Dir%\loadeddllsview.txt" > "%PROCESS_HASH%\loadeddllsview_hash.txt"
echo [!timestamp!] LOADEDDLLSVIEW HASH >> %_TimeStamp%

%hashdeep% -c sha1,md5,sha256 "%PROCESS_Dir%\driveview.txt" > "%PROCESS_HASH%\driveview_hash.txt"
echo [!timestamp!] DRIVEVIEW HASH >> %_TimeStamp%

%hashdeep% -c sha1,md5,sha256 "%PROCESS_Dir%\cprocess.txt" > "%PROCESS_HASH%\cprocess_hash.txt"
echo [!timestamp!] CPROCESS HASH >> %_TimeStamp%

%hashdeep% -c sha1,md5,sha256 "%PROCESS_Dir%\openedfilesview.txt" > "%PROCESS_HASH%\openedfilesview_hash.txt"
echo [!timestamp!] OPENEDFILESVIEW HASH >> %_TimeStamp%

%hashdeep% -c sha1,md5,sha256 "%PROCESS_Dir%\opensavefilesview.txt" > "%PROCESS_HASH%\opensavefilesview_hash.txt"
echo [!timestamp!] OPENSAVEFILESVIEW HASH >> %_TimeStamp%

%hashdeep% -c sha1,md5,sha256 "%PROCESS_Dir%\executedprogramslist.txt" > "%PROCESS_HASH%\executedprogramslist_hash.txt"
echo [!timestamp!] EXECUTEDPROGRAMSLIST HASH >> %_TimeStamp%

%hashdeep% -c sha1,md5,sha256 "%PROCESS_Dir%\installedpackagesview.txt" > "%PROCESS_HASH%\installedpackagesview_hash.txt"
echo [!timestamp!] INSTALLEDPACKAGESVIEW HASH >> %_TimeStamp%

%hashdeep% -c sha1,md5,sha256 "%PROCESS_Dir%\uninstallview.txt" > "%PROCESS_HASH%\uninstallview_hash.txt"
echo [!timestamp!] UNINSTALLVIEW HASH >> %_TimeStamp%

%hashdeep% -c sha1,md5,sha256 "%PROCESS_Dir%\mylastsearch.txt" > "%PROCESS_HASH%\mylastsearch_hash.txt"
echo [!timestamp!] MYLASTSEARCH HASH >> %_TimeStamp%

%hashdeep% -c sha1,md5,sha256 "%PROCESS_Dir%\browseraddonsview.txt" > "%PROCESS_HASH%\browseraddonsview_hash.txt"
echo [!timestamp!] BROWSERADDONSVIEW HASH >> %_TimeStamp%

%hashdeep% -c sha1,md5,sha256 "%PROCESS_Dir%\browserdownloadsview.txt" > "%PROCESS_HASH%\browserdownloadsview_hash.txt"
echo [!timestamp!] BROWSERDOWNLOADSVIEW HASH >> %_TimeStamp%

%hashdeep% -c sha1,md5,sha256 "%PROCESS_Dir%\browsinghistoryview.txt" > "%PROCESS_HASH%\browsinghistoryview_hash.txt"
...
%hashdeep% -c sha1,md5,sha256 "%Logon_Dir%\psloggedon.txt" > "%LOGON_HASH%\psloggedon_hash.txt"
echo [!timestamp!] PSLOGGEDON HASH >> %_TimeStamp%

%hashdeep% -c sha1,md5,sha256 "%Logon_Dir%\logonsessions.txt" > "%LOGON_HASH%\logonsessions_hash.txt"
echo [!timestamp!] LOGONSESSIONS HASH >> %_TimeStamp%

%hashdeep% -c sha1,md5,sha256 "%Logon_Dir%\net_user.txt" > "%LOGON_HASH%\net_user_hash.txt"
echo [!timestamp!] NET USER HASH >> %_TimeStamp%

%hashdeep% -c sha1,md5,sha256 "%Logon_Dir%\winlogonview.txt" > "%LOGON_HASH%\winlogonview_hash.txt"
...
:: systeminfo hash
:: --------------------
%hashdeep% -c sha1,md5,sha256 "%SYSTEM_INFO_Dir%\systeminfo.txt" > "%SYSTEM_INFO_HASH%\systeminfo_HASH.txt"
echo [!timestamp!] systeminfo HASH >> %_TimeStamp%

:: --------------------
:: system log hash
:: --------------------
%hashdeep% -c sha1,md5,sha256 "%SYSTEM_INFO_Dir%\system_log.evtx" > "%SYSTEM_INFO_HASH%\system_log_HASH.txt"
echo [!timestamp!] wevtutil system HASH >> %_TimeStamp%

:: --------------------
:: security log hash
:: --------------------
%hashdeep% -c sha1,md5,sha256 "%SYSTEM_INFO_Dir%\security_log.evtx" > "%SYSTEM_INFO_HASH%\security_log_HASH.txt"
echo [!timestamp!] wevtutil security HASH >> %_TimeStamp%

:: --------------------
:: application log hash
:: --------------------
%hashdeep% -c sha1,md5,sha256 "%SYSTEM_INFO_Dir%\application_log.evtx" > "%SYSTEM_INFO_HASH%\application_log_HASH.txt"
echo [!timestamp!] wevtutil application HASH >> %_TimeStamp%

:: --------------------
:: SAM FILE HASH
:: --------------------
%hashdeep% -c sha1,md5,sha256 "%SYSTEM_INFO_Dir%\SAM.hiv" > "%SYSTEM_INFO_HASH%\SAM_HASH.txt"
echo [!timestamp!] SAM HASH >> %_TimeStamp%

:: --------------------
:: SOFTWARE FILE HASH
:: --------------------
%hashdeep% -c sha1,md5,sha256 "%SYSTEM_INFO_Dir%\HKLM-Software.hiv" > "%SYSTEM_INFO_HASH%\HKLM-Software_HASH.txt"
echo [!timestamp!] HKLM-Software HASH >> %_TimeStamp%

:: --------------------
:: SYSTEM FILE HASH
:: --------------------
%hashdeep% -c sha1,md5,sha256 "%SYSTEM_INFO_Dir%\SYSTEM.hiv" > "%SYSTEM_INFO_HASH%\SYSTEM_HASH.txt"
echo [!timestamp!] SYSTEM HASH >> %_TimeStamp%

:: --------------------
:: SECURITY FILE HASH
:: --------------------
%hashdeep% -c sha1,md5,sha256 "%SYSTEM_INFO_Dir%\SECURITY.hiv" > "%SYSTEM_INFO_HASH%\SECURITY_HASH.txt"
echo [!timestamp!] SECURITY HASH >> %_TimeStamp%

:: --------------------
:: BLUESCREENVIEW_HASH
:: --------------------
%hashdeep% -c sha1,md5,sha256 "%SYSTEM_INFO_Dir%\bluescreenview.txt" > "%SYSTEM_INFO_HASH%\BLUESCREENVIEW_HASH.txt"
...
%hashdeep% -c sha1,md5,sha256 "%Autoruns_Dir%\HKLM-Run.reg" > "%Autoruns_HASH%\HKLM-Run_HASH.txt"
echo [!timestamp!] HKLM-Run HASH >> %_TimeStamp%
%hashdeep% -c sha1,md5,sha256 "%Autoruns_Dir%\HKCU-Run.reg" > "%Autoruns_HASH%\HKCU-Run_HASH.txt"
echo [!timestamp!] HKCU-Run HASH >> %_TimeStamp%
%hashdeep% -c sha1,md5,sha256 "%Autoruns_Dir%\services.txt" > "%Autoruns_HASH%\services_HASH.txt"
echo [!timestamp!] services HASH >> %_TimeStamp%
%hashdeep% -c sha1,md5,sha256 "%Autoruns_Dir%\wecutil-es.txt" > "%Autoruns_HASH%\wecutil-es_HASH.txt"
echo [!timestamp!] wecutil-es HASH >> %_TimeStamp%
%hashdeep% -c sha1,md5,sha256 "%Autoruns_Dir%\AutoRuns.csv" > "%Autoruns_HASH%\AutoRuns_HASH.txt"
echo [!timestamp!] AutoRuns HASH >> %_TimeStamp%
%hashdeep% -c sha1,md5,sha256 "%Autoruns_Dir%\Startup_ProgramData.txt" > "%Autoruns_HASH%\Startup_ProgramData_HASH.txt"
echo [!timestamp!] Startup_ProgramData HASH >> %_TimeStamp%
%hashdeep% -c sha1,md5,sha256 "%Autoruns_Dir%\Startup_UserPaths.txt" > "%Autoruns_HASH%\Startup_UserPaths_HASH.txt"
...
%hashdeep% -c sha1,md5,sha256 "%TSCB_Dir%\clipboard.txt" > "%TSCB_HASH%\clipboard_HASH.txt"
echo [!timestamp!] clipboard HASH >> %_TimeStamp%
%hashdeep% -c sha1,md5,sha256 "%TSCB_Dir%\ScheduledTasks.csv" > "%TSCB_HASH%\ScheduledTasks_HASH.txt"
