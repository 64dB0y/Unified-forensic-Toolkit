...
mkdir ../mnt2/Process
timestamp=$(date +"%Y-%m-%d %T")
echo "Proces Directory Timestamp : $timestamp" >> ../mnt2/Forensic_Info.txt
...
timestamp=$(date +"%Y-%m-%d %T")
echo "status_info.txt Timestamp : $timestamp" >> ../mnt2/Forensic_Info.txt
